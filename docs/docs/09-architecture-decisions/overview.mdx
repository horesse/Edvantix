...
sidebar_position: 1
title: Overview
description: Architecture Decision Records (ADRs) documenting significant architectural choices and their rationale for Edvantix
...
This section documents significant architectural decisions made for the Edvantix project using Architecture Decision Records (ADRs). Each ADR captures the context, decision, rationale, and consequences of important architectural choices that shape the system's design and implementation.

## Decision Timeline

```mermaid
gantt
    title Edvantix Architecture Decisions Timeline
...
Based on the ADR decisions, Edvantix follows these core principles:
