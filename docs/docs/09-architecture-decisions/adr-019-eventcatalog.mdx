...
Edvantix's event-driven microservices architecture produces numerous domain events, integration events, and system events that require comprehensive documentation and discoverability. The event documentation challenges include:
...
Adopt **EventCatalog** as the primary platform for documenting, discovering, and managing events across Edvantix's event-driven architecture, integrated with code generation and CI/CD pipelines.
...
module.exports = {
  title: 'Edvantix Event Catalog',
  tagline: 'Discover and understand events in the Edvantix ecosystem',
  organizationName: 'Edvantix',
  projectName: 'Edvantix-Events',

  editUrl: 'https://github.com/Edvantix/eventcatalog/edit/main',
  ...
  footerLinks: [
    {
      label: 'GitHub',
      href: 'https://github.com/Edvantix/eventcatalog',
    },
    {
      label: 'API Documentation',
      href: 'https://api.Edvantix.com/docs',
    },
  ],
