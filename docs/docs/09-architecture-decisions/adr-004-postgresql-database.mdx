...
description: Choice of PostgreSQL as primary database for ACID compliance and JSON support
keywords: [ADR-004, PostgreSQL, database, ACID, JSON support, relational database, Entity Framework Core]
last_update:
  author: Nhan Nguyen
---
...
Edvantix's microservices architecture requires a robust, scalable, and feature-rich database solution that can support diverse data patterns across multiple services. The system has specific requirements:
