...
sidebar_position: 1
title: Overview
description: Cross-cutting concepts and architectural patterns implemented across all Edvantix microservices
keywords: [cross-cutting concepts, Edvantix Chassis, service defaults, CQRS, event-driven architecture, repository pattern]
last_update:
  author: Nhan Nguyen
---
...
This section describes the cross-cutting concepts that are implemented across all services in the Edvantix application. These concepts ensure consistency, maintainability, and operational excellence throughout the system.

## Architecture Components

The Edvantix application implements cross-cutting concerns through two main components:
