...
namespace Edvantix.EntityHub.Extensions;
...
public static class Extensions
{
    public static void AddApplicationServices(this IHostApplicationBuilder builder)
    {
            ...
            .AddPolicy(
                ...
                policy =>
                {
                    policy
                        ...
                        .RequireScope(
                            $"{Services.EntityHub}_{Authorization.Actions.Read}",
                            $"{Services.EntityHub}_{Authorization.Actions.Write}"
                        );
                }
            )
            .SetDefaultPolicy(
                new AuthorizationPolicyBuilder()
                    .RequireAuthenticatedUser()
                    .RequireScope($"{Services.EntityHub}_{Authorization.Actions.Read}")
                    .Build()
            );
        ...
        services.AddValidatorsFromAssemblyContaining<IEntityHubApiMarker>(
        ...
        services.AddEndpoints(typeof(IEntityHubApiMarker));

        services.AddConverter(typeof(IEntityHubApiMarker));
