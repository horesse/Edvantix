...
description: Implementation of Agent-to-Agent protocol for multi-agent AI system communication
keywords: [ADR-021, A2A protocol, agent-to-agent, multi-agent systems, AI communication, agent orchestration]
last_update:
  author: Nhan Nguyen
---
...
Adopt **Agent2Agent (A2A) Protocol** as the standardized communication protocol for AI agent coordination in the Edvantix intelligent chat system, enabling seamless collaboration between specialized agents.
...
2. **Interoperability**: Enables seamless communication between agents built with different frameworks (Agent Framework, LangGraph, etc.)
...
1. **Agent Framework Integration**: A2A Protocol integrates natively with Microsoft Agent Framework agent framework
...
- **Provider Information**: Edvantix organization identifier
