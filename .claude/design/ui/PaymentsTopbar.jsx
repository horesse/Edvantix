// Topbar specialized for the Payments page.
    ...
    <div style={{
      ...
      <div style={{flex:1,minWidth:0}}>
        <div style={{display:'flex',alignItems:'center',gap:8,fontSize:12,color:'#94a3b8',marginBottom:4}}>
          ...
          <span style={{color:'#475569',fontWeight:500}}>Платежи</span>
        </div>
        <h1 style={{margin:0,fontSize:24,fontWeight:700,letterSpacing:'-0.02em'}}>Платежи</h1>
        <div style={{fontSize:13,color:'#64748b',marginTop:2}}>
          247 транзакций · Школа «Креатив Плюс»
        </div>
      </div>
      <div style={{display:'flex',alignItems:'center',gap:10}}>
        ...
        <Button variant="secondary"><Icon.Download size={15}/>Экспорт</Button>
        <Button><Icon.Plus size={16}/>Принять платёж</Button>
      </div>
    </div>
  );
}

window.PaymentsTopbar = PaymentsTopbar;
