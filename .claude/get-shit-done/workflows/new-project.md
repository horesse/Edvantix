...
```bash
INIT=$(node "E:/projects/Edvantix/.claude/get-shit-done/bin/gsd-tools.cjs" init new-project)
...
```bash
mkdir -p .planning
node "E:/projects/Edvantix/.claude/get-shit-done/bin/gsd-tools.cjs" commit "chore: add project config" --files .planning/config.json
```
...
```bash
mkdir -p .planning
node "E:/projects/Edvantix/.claude/get-shit-done/bin/gsd-tools.cjs" commit "docs: initialize project" --files .planning/PROJECT.md
```
...
Use template: E:/projects/Edvantix/.claude/get-shit-done/templates/research-project/STACK.md
</output>
...
Use template: E:/projects/Edvantix/.claude/get-shit-done/templates/research-project/FEATURES.md
</output>
...
Use template: E:/projects/Edvantix/.claude/get-shit-done/templates/research-project/ARCHITECTURE.md
</output>
...
Use template: E:/projects/Edvantix/.claude/get-shit-done/templates/research-project/PITFALLS.md
</output>
...
Use template: E:/projects/Edvantix/.claude/get-shit-done/templates/research-project/SUMMARY.md
...
```bash
node "E:/projects/Edvantix/.claude/get-shit-done/bin/gsd-tools.cjs" commit "docs: define v1 requirements" --files .planning/REQUIREMENTS.md
```
...
```bash
node "E:/projects/Edvantix/.claude/get-shit-done/bin/gsd-tools.cjs" generate-claude-md
```
...
```bash
node "E:/projects/Edvantix/.claude/get-shit-done/bin/gsd-tools.cjs" commit "docs: create roadmap ([N] phases)" --files .planning/ROADMAP.md .planning/STATE.md .planning/REQUIREMENTS.md CLAUDE.md
```
