...
/// <summary>
/// Базовый обработчик с общей логикой для CRUD операций с ViewModels
/// </summary>
public abstract class BaseCrudViewModelHandler<TModel, TIdentity, TEntity>(
    ...
    where TEntity : Entity<TIdentity>, IAggregateRoot
{
    ...
    private readonly ILogger _logger = provider.GetRequiredService<
        ILogger<BaseCrudViewModelHandler<TModel, TIdentity, TEntity>>
    >();
