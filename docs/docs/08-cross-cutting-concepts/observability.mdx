...
sidebar_position: 8
title: Observability
description: Comprehensive observability with OpenTelemetry for metrics, logging, and distributed tracing
keywords: [observability, OpenTelemetry, metrics, distributed tracing, logging, telemetry, performance monitoring]
last_update:
  author: Nhan Nguyen
---
...
The Edvantix application implements comprehensive observability using OpenTelemetry, providing insights into application performance, behavior, and health across the distributed system.
