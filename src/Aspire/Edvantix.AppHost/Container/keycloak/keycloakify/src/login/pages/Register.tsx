...
export default function Register(
    props: Readonly<PageProps<Extract<KcContext, { pageId: "register.ftl" }>, I18n>>
) {
    ...
    const [formState, setFormState] = useState<FormState>({
        email: { value: register.formData.email ?? "", touched: false, error: null },
        username: { value: register.formData.username ?? "", touched: false, error: null },
            ...
            onChange: (e: React.ChangeEvent<HTMLInputElement>) => {
                ...
                setFormState((prev) => ({
                    ...
                    [fieldName]: {
                        ...
                        error: prev[fieldName].touched ? validator(value, ...validatorArgs) : null,
                    },
                }));
            },
            onBlur: () => {
