...
/// <summary>
/// Generic endpoint для получения записи по ID с маппингом в обычный Model
/// </summary>
public class GetByIdWithViewModelEndpoint<TModel, TIdentity>
    ...
    where TIdentity : struct
{
    public virtual void MapEndpoint(IEndpointRouteBuilder app)
    {
        ...
        ConfigureEndpoint(
                ...
                $"Возвращает полную запись (Model) по уникальному идентификатору"
            )
