...
using Edvantix.OrganizationManagement.Features;
...
namespace Edvantix.OrganizationManagement.Extensions;
            ...
            .AddPolicy(
                ...
                policy =>
                {
                    policy
                        ...
                        .RequireScope(
                            $"{Services.Organization}_{Authorization.Actions.Read}",
                            $"{Services.Organization}_{Authorization.Actions.Write}"
                        );
                }
            )
            .SetDefaultPolicy(
                new AuthorizationPolicyBuilder()
                    .RequireAuthenticatedUser()
                    .RequireScope($"{Services.Organization}_{Authorization.Actions.Read}")
                    .Build()
            );
