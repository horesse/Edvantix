...
namespace Edvantix.Organizational.Infrastructure.Migrations
{
    ...
    public partial class Initial : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    organization_id = table.Column<decimal>(type: "numeric(20,0)", nullable: false),
                    invited_by_profile_id = table.Column<decimal>(
                        type: "numeric(20,0)",
                        nullable: false
                    ),
                    invitee_profile_id = table.Column<decimal>(
                        type: "numeric(20,0)",
                        nullable: true
                    ),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    name_latin = table.Column<string>(
                        type: "character varying(500)",
                        maxLength: 500,
                        nullable: false
                    ),
                    ...
                    print_name = table.Column<string>(
                        type: "character varying(500)",
                        maxLength: 500,
                        nullable: true
                    ),
                    ...
                    registration_date = table.Column<DateTime>(
                        type: "timestamp with time zone",
                        nullable: false
                    ),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    group_id = table.Column<decimal>(type: "numeric(20,0)", nullable: false),
                    profile_id = table.Column<decimal>(type: "numeric(20,0)", nullable: false),
                    role = table.Column<int>(type: "integer", nullable: false),
                    joined_at = table.Column<DateTime>(
                        type: "timestamp with time zone",
            ...
            migrationBuilder.CreateIndex(name: "ix_group_name", table: "group", column: "name");
        ...
        {
            migrationBuilder.DropTable(name: "group_member");

            migrationBuilder.DropTable(name: "invitation");

            migrationBuilder.DropTable(name: "organization_contact");

            migrationBuilder.DropTable(name: "organization_member");
