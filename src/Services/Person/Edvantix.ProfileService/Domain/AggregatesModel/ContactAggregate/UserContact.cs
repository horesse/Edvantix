...
namespace Edvantix.ProfileService.Domain.AggregatesModel.ContactAggregate;

public sealed class UserContact() : PersonalData<long>, ISoftDelete, IAggregateRoot
{
    internal UserContact(ContactType type, string value, string? description = null)
        : this()
    {
