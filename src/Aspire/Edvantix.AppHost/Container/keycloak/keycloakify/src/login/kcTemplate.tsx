...
export default function Template(props: TemplateProps<KcContext, I18n>) {
  ...
  return (
    <div
      className={clsx(
        "relative flex h-auto min-h-screen items-center justify-center overflow-x-hidden px-4 py-10 sm:px-6 lg:px-8",
        bodyClassName
      )}
    >
          ...
          <div
            className={clsx(
              ...
              message.type === "warning" &&
                "bg-yellow-50 dark:bg-yellow-950/20 border border-yellow-200 dark:border-yellow-800 text-yellow-800 dark:text-yellow-200",
              message.type === "error" &&
