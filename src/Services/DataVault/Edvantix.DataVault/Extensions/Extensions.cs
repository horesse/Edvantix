            ...
            .AddPolicy(
                ...
                policy =>
                {
                    policy
                        ...
                        .RequireScope(
                            $"{Services.DataVault}_{Authorization.Actions.Read}",
                            $"{Services.DataVault}_{Authorization.Actions.Write}"
                        );
                }
            )
            .SetDefaultPolicy(
                new AuthorizationPolicyBuilder()
                    .RequireAuthenticatedUser()
                    .RequireScope($"{Services.DataVault}_{Authorization.Actions.Read}")
                    .Build()
            );
