...
public sealed class DomainConventionTests : ArchUnitBaseTest
{
    ...
    public void GivenDomainServices_WhenCheckingStructure_ThenShouldBeSealed()
    {
        Classes()
            ...
            .And()
            .ResideInNamespaceMatching($"{nameof(Edvantix)}")
            .Should()
            .BePublic()
            .OrShould()
            .BeInternal()
    ...
    public void GivenDomainExceptions_WhenCheckingConventions_ThenShouldFollowStandardRules()
    {
        Classes()
            ...
            .ResideInNamespaceMatching($"{nameof(Edvantix)}")
            .And()
            .DoNotResideInNamespaceMatching($"{nameof(Edvantix)}.Chassis.*")
            .And()
            .DoNotResideInNamespaceMatching($"{nameof(Edvantix)}.*.Infrastructure.*")
            .Should()
            .BeSealed()
            .AndShould()
