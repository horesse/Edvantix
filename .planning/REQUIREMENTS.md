...
- [x] **SCH-01**: Менеджер может создать слот расписания (группа + дата/время + учитель) с проверкой конфликтов учителя
- [x] **SCH-02**: Менеджер может редактировать и удалять слоты расписания
- [x] **SCH-03**: Менеджер видит расписание всех групп своей школы
- [x] **SCH-04**: Учитель видит только своё расписание
- [x] **SCH-05**: Студент видит только свои уроки (группы, в которых состоит)
