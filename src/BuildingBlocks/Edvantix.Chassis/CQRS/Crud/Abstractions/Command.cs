...
/// </summary>
public sealed record CreateCommand<TModel, TIdentity>(TModel Model) 
    : ICommand<TIdentity>
...
/// Обновление записи
/// </summary>
public sealed record UpdateCommand<TModel, TIdentity>(TModel Model) 
    : ICommand<TIdentity>
    where TModel : Model<TIdentity>
    where TIdentity : struct;
...
/// </summary>
public sealed record AcceptChangesCommand<TModel, TIdentity>(TModel Model) 
    : ICommand<bool>
    where TModel : Model<TIdentity>
    where TIdentity : struct;
