...
public sealed class ArchiveOrganizationCommandHandlerTests
{
    ...
    [Test]
    public async Task GivenExistingOrganization_WhenHandling_ThenShouldArchiveOrganization()
    {
        ...
        await _handler.Handle(new ArchiveOrganizationCommand(orgId), CancellationToken.None);
    ...
    public async Task GivenOrganizationNotFound_WhenHandling_ThenShouldThrowNotFoundException()
    {
        ...
        await Should.ThrowAsync<NotFoundException>(() =>
            _handler.Handle(new ArchiveOrganizationCommand(orgId), CancellationToken.None).AsTask()
        );
    }
