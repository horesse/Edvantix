...
namespace Edvantix.Organizational.Infrastructure.Migrations
{
    ...
    [Migration("20260525163749_ConsolidateDirectoriesToOrganizational")]
    partial class ConsolidateDirectoriesToOrganizational
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Edvantix.Organizational.Domain.AggregatesModel.LevelAggregate.Level", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("Edvantix.Organizational.Domain.AggregatesModel.StudentTagAggregate.StudentTag", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.HasKey("Id")
                        .HasName("pk_student_tags");

                    b.HasIndex("OrganizationId")
                        .HasDatabaseName("ix_student_tags_org_id");
                    ...
                    b.ToTable("student_tags", (string)null);
                });

            modelBuilder.Entity("Edvantix.Organizational.Domain.AggregatesModel.SubjectAggregate.Subject", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.HasIndex("OrganizationId", "Code")
                        .IsUnique()
                        .HasDatabaseName("ix_subjects_organization_id_code")
                        .HasFilter("is_archived = false");

                    b.HasIndex("OrganizationId", "IsArchived")
                        .HasDatabaseName("ix_subjects_organization_id_is_archived");

                    b.HasIndex("OrganizationId", "Name")
                        .IsUnique()
                        .HasDatabaseName("ix_subjects_organization_id_name")
                        .HasFilter("is_archived = false");

                    b.ToTable("subjects", (string)null);
                });

            modelBuilder.Entity("Edvantix.Organizational.Domain.LessonTypeAggregate.LessonType", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
