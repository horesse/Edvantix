    ...
    : IDbSeeder<OrganizationalDbContext>
{
    ...
    private async Task SeedLegalFormsAsync(OrganizationalDbContext context)
    {
        ...
        {
            new("ООО (общество с ограниченной ответственностью)", "ООО"),
            new("ОАО (открытое акционерное общество)", "ОАО"),
            new("ЗАО (закрытое акционерное общество)", "ЗАО"),
            new("УП (унитарное предприятие)", "УП"),
            new("ЧУП (частное унитарное предприятие)", "ЧУП"),
            new("ИП (индивидуальный предприниматель)", "ИП"),
            ...
            new("Учреждение образования (общее)", "УО"),
        };
