...
namespace Edvantix.Organizational.Infrastructure.Migrations
{
    ...
    [Migration("20260301110325_AddLegalFormAndOrganizationType")]
    partial class AddLegalFormAndOrganizationType
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Edvantix.Organizational.Domain.AggregatesModel.LegalFormAggregate.LegalForm", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("Edvantix.Organizational.Domain.AggregatesModel.OrganizationAggregate.Organization", b =>
                {
                    ...
                    b.HasIndex("LegalFormId")
                        .HasDatabaseName("ix_organization_legal_form_id");
            ...
            modelBuilder.Entity("Edvantix.Organizational.Domain.AggregatesModel.OrganizationAggregate.OrganizationContact", b =>
                {
                    ...
                    b.HasKey("Id")
                        .HasName("pk_organization_contact");

                    b.HasIndex("OrganizationId")
                        .HasDatabaseName("ix_organization_contact_organization_id");

                    b.HasIndex("Type")
                        .HasDatabaseName("ix_organization_contact_type");
            ...
            modelBuilder.Entity("Edvantix.Organizational.Domain.AggregatesModel.GroupAggregate.Group", b =>
                {
                    b.HasOne("Edvantix.Organizational.Domain.AggregatesModel.OrganizationAggregate.Organization", "Organization")
                        .WithMany("Groups")
            ...
            modelBuilder.Entity("Edvantix.Organizational.Domain.AggregatesModel.GroupAggregate.GroupMember", b =>
                {
                    b.HasOne("Edvantix.Organizational.Domain.AggregatesModel.GroupAggregate.Group", "Group")
                        .WithMany("Members")
            ...
            modelBuilder.Entity("Edvantix.Organizational.Domain.AggregatesModel.OrganizationAggregate.Organization", b =>
                {
                    b.HasOne("Edvantix.Organizational.Domain.AggregatesModel.LegalFormAggregate.LegalForm", "LegalForm")
                        .WithMany()
            ...
            modelBuilder.Entity("Edvantix.Organizational.Domain.AggregatesModel.OrganizationAggregate.OrganizationContact", b =>
                {
                    b.HasOne("Edvantix.Organizational.Domain.AggregatesModel.OrganizationAggregate.Organization", "Organization")
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_organization_contact_organization_organization_id");
