...
Edvantix's microservices architecture requires a robust continuous integration and deployment pipeline to support rapid development, automated testing, and reliable deployments across multiple environments. The CI/CD requirements include:
...
| ---------------------- | ------------------------------- | ---------------------------------------------------------------------------------- | ----------------------------------------------------- |
| **Edvantix CI**        | Push to main, Workflow dispatch | Complete CI pipeline with build, test, security scanning, and container publishing | Multi-stage pipeline with reusable actions            |
...
services:
  - Basket: foxminchan/Edvantix/basket
  - Catalog: foxminchan/Edvantix/catalog
  - Finance: foxminchan/Edvantix/finance
  - Notification: foxminchan/Edvantix/notification
  - Ordering: foxminchan/Edvantix/ordering
  - Rating: foxminchan/Edvantix/rating
  - Chat: foxminchan/Edvantix/chat
  - MCP Tools: foxminchan/Edvantix/mcptools
```
