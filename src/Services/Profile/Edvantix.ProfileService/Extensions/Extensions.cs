...
using Edvantix.ProfileService.Features;
...
namespace Edvantix.ProfileService.Extensions;
...
public static class Extensions
{
    public static void AddApplicationServices(this IHostApplicationBuilder builder)
    {
            ...
            .AddPolicy(
                ...
                policy =>
                {
                    policy
                        ...
                        .RequireScope(
                            $"{Services.Profile}_{Authorization.Actions.Read}",
                            $"{Services.Profile}_{Authorization.Actions.Write}"
                        );
                }
            )
            .SetDefaultPolicy(
                new AuthorizationPolicyBuilder()
                    .RequireAuthenticatedUser()
                    .RequireScope($"{Services.Profile}_{Authorization.Actions.Read}")
                    .Build()
            );
        ...
        {
            cfg.RegisterServicesFromAssembly(typeof(IProfileApiMarker).Assembly);
        ...
        services.AddValidatorsFromAssemblyContaining<IProfileApiMarker>(includeInternalTypes: true);
        ...
        services.AddEndpoints(typeof(IProfileApiMarker));

        services.AddConverter(typeof(IProfileApiMarker));
