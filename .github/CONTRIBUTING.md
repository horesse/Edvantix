# Contributing to Edvantix

🎉 Thank you for your interest in contributing to Edvantix!

Edvantix is a cloud-native microservices application showcasing .NET Aspire, Domain-Driven Design, and AI integration. We welcome contributions of all kinds: bug fixes, features, documentation improvements, and more.
...
- [Contributing to Edvantix](#contributing-to-Edvantix)
...
1. **Fork the Repository**: Start by forking the main Edvantix repository.
2. **Clone Your Fork**:
   ```bash
   git clone https://github.com/YOUR-USERNAME/Edvantix.git
   cd Edvantix
   ```

3. **Add Upstream Remote**:
   ```bash
   git remote add upstream https://github.com/edvantix/Edvantix.git
   ```
...
Edvantix includes AI agents to assist with development tasks. These agents work collaboratively through a structured handoff system:
...
- Always use the `Edvantix.Contracts` namespace when declaring integration events
...
- **Architecture Tests**: Use ArchUnitNET.TUnit in `tests/Edvantix.ArchTests/`
...
1. **Code Quality**:
   - Follow Edvantix's coding standards and conventions
...
- 🐛 **Bug Reports**: [Create a bug report](https://github.com/edvantix/Edvantix/issues/new?template=bug-report.yml)
- 💡 **Feature Requests**: [Submit a feature request](https://github.com/edvantix/Edvantix/issues/new?template=feature-request.yml)
...
Thank you for contributing to Edvantix! 🚀
