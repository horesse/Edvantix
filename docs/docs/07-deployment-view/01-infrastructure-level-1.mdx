...
description: High-level deployment architecture showing major infrastructure components and development vs production environments
keywords: [infrastructure, deployment diagram, development environment, production environment, Docker, Azure Container Apps]
last_update:
  author: Nhan Nguyen
---
...
This level shows the high-level deployment architecture of the Edvantix application, focusing on the major infrastructure components and their relationships.

## Architecture Diagram

```mermaid
C4Context
    title Deployment Diagram for Edvantix Application

    Enterprise_Boundary(b0, "Edvantix System") {
