...
public sealed class ArchiveLevelDirectoryEndpointTests
{
    private readonly ArchiveLevelDirectoryEndpoint _endpoint = new();
    ...
    public async Task GivenExistingLevel_WhenHandling_ThenDelegatesToSender()
    {
        ...
        _senderMock.Verify(
            s =>
                s.Send(
                    It.Is<ArchiveLevelDirectoryCommand>(c => c.Id == id),
