...
Use template from `E:/projects/Edvantix/.claude/get-shit-done/templates/UI-SPEC.md`.
...
Read template: `E:/projects/Edvantix/.claude/get-shit-done/templates/UI-SPEC.md`
...
```bash
node "E:/projects/Edvantix/.claude/get-shit-done/bin/gsd-tools.cjs" commit "docs($PHASE): UI design contract" --files "$PHASE_DIR/$PADDED_PHASE-UI-SPEC.md"
```
