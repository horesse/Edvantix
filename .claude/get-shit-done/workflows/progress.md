...
```bash
INIT=$(node "E:/projects/Edvantix/.claude/get-shit-done/bin/gsd-tools.cjs" init progress)
...
- `STATE=$(node "E:/projects/Edvantix/.claude/get-shit-done/bin/gsd-tools.cjs" state-snapshot)`
...
- Use `summary-extract` for efficient parsing:
  ```bash
  node "E:/projects/Edvantix/.claude/get-shit-done/bin/gsd-tools.cjs" summary-extract <path> --fields one_liner
  ```
...
PROGRESS_BAR=$(node "E:/projects/Edvantix/.claude/get-shit-done/bin/gsd-tools.cjs" progress bar --raw)
```
...
```bash
DEBT=$(node "E:/projects/Edvantix/.claude/get-shit-done/bin/gsd-tools.cjs" audit-uat --raw 2>/dev/null)
```
