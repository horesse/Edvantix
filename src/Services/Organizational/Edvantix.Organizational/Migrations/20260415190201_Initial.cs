...
namespace Edvantix.Organizational.Migrations
{
    /// <inheritdoc />
    public partial class Initial : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    id = table.Column<Guid>(type: "uuid", nullable: false, defaultValueSql: "uuidv7()"),
                    full_legal_name = table.Column<string>(type: "character varying(500)", maxLength: 500, nullable: false),
                    ...
                    legal_form = table.Column<string>(type: "character varying(50)", maxLength: 50, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("pk_group_role_permissions", x => new { x.role_id, x.permission_id });
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                name: "organization_member_role_permissions",
                columns: table => new
                {
                    role_id = table.Column<Guid>(type: "uuid", nullable: false),
                    permission_id = table.Column<Guid>(type: "uuid", nullable: false)
                ...
                constraints: table =>
                {
                    table.PrimaryKey("pk_organization_member_role_permissions", x => new { x.role_id, x.permission_id });
                    table.ForeignKey(
                        name: "fk_organization_member_role_permissions_organization_member_ro",
                        column: x => x.role_id,
                        principalTable: "organization_member_roles",
                        principalColumn: "id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "fk_organization_member_role_permissions_permissions_permission",
                        column: x => x.permission_id,
                        principalTable: "permissions",
                        principalColumn: "id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "ix_organization_member_role_permissions_permission_id",
                table: "organization_member_role_permissions",
                column: "permission_id");
