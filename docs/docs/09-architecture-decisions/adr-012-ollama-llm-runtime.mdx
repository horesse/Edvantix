...
Edvantix's AI-enhanced features require a robust, scalable, and cost-effective Large Language Model (LLM) runtime to power intelligent functionalities across the platform. The requirements include:
...
Adopt **Ollama** as the primary Large Language Model runtime, integrated with **Microsoft Agent Framework** for AI orchestration, to provide powerful, cost-effective, and privacy-conscious AI capabilities across Edvantix's platform.
...
graph TB
    subgraph "Client Applications"
        WebApp[Edvantix Web App<br/>User Interface]
        MobileApp[Edvantix Mobile<br/>iOS/Android]
        AdminPanel[Admin Panel<br/>Management Interface]
        API[Edvantix API<br/>External Integrations]
    end
