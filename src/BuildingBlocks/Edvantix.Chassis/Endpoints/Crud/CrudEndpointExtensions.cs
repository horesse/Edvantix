...
public static class CrudEndpointExtensions
{
    extension(IServiceCollection services)
    {
        ...
        public IServiceCollection AddCrudEndpoints<TEntity, TModel, TIdentity, TSpecification>(
            ...
            where TSpecification : class, ISpecification<TEntity>, new()
        {
            services.RegisterCrudEndpointsCore<
                TModel,
                TModel,
                TModel,
                TIdentity,
        ...
        /// <summary>
        /// Регистрирует общие CRUD query и command endpoints для указанных типов.
        /// TCreateModel — тип для endpoint создания, TViewModel — тип для результатов GetByExpression.
        /// </summary>
        private IServiceCollection RegisterCrudEndpointsCore<
            TModel,
            TCreateModel,
            TViewModel,
            TIdentity,
            ...
            where TSpecification : class, ISpecification<TEntity>, new()
        {
            ...
            {
                services.AddTransient<IEndpoint, CreateEndpoint<TCreateModel, TIdentity>>();
            }
