...
keywords: [ADR-018, K6, performance testing, load testing, stress testing, scalability, benchmarking]
last_update:
  author: Nhan Nguyen
---
...
Edvantix's microservices architecture requires comprehensive performance testing to ensure scalability, reliability, and optimal user experience under various load conditions. The performance testing requirements include:
...
### Edvantix Performance Testing Coverage
...
1. **High Performance**: Go-based runtime capable of generating significant load from single instance
...
const environments = {
  development: {
    baseUrl: 'https://dev-api.Edvantix.local',
    users: 50,
    duration: '2m'
  },
  staging: {
    baseUrl: 'https://staging-api.Edvantix.com',
    users: 200,
    duration: '10m'
  },
  production: {
    baseUrl: 'https://api.Edvantix.com',
    users: 500,
    duration: '30m'
  }
};
