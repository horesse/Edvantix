...
description: Repository and Specification patterns for clean data access abstraction and flexible query composition
keywords: [repository pattern, specification pattern, data access, Entity Framework Core, query composition, unit of work]
last_update:
  author: Nhan Nguyen
---
...
The Edvantix application implements the Repository pattern combined with the Specification pattern to provide clean data access abstraction and flexible query composition while maintaining separation between domain logic and data persistence.
