...
namespace Edvantix.Organizational.Migrations
{
    ...
    [Migration("20260415190201_Initial")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Edvantix.Organizational.Domain.AggregatesModel.GroupAggregate.GroupMembershipHistory", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.HasKey("Id")
                        .HasName("pk_group_membership_histories");

                    b.HasIndex("GroupMemberId")
                        .HasDatabaseName("ix_group_membership_histories_group_member_id");

                    b.ToTable("group_membership_histories", null, t =>
                        {
                            t.HasComment("Иммутабельный журнал вступления и выхода участников из групп.");
                        });
                });
            ...
            modelBuilder.Entity("Edvantix.Organizational.Infrastructure.GroupRolePermission", b =>
                {
                    b.Property<Guid>("GroupRoleId")
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("Edvantix.Organizational.Infrastructure.OrganizationMemberRolePermission", b =>
                {
                    b.Property<Guid>("OrganizationMemberRoleId")
                        .HasColumnType("uuid")
                        .HasColumnName("role_id");
                    ...
                    b.HasKey("OrganizationMemberRoleId", "PermissionId")
                        .HasName("pk_organization_member_role_permissions");

                    b.HasIndex("PermissionId")
                        .HasDatabaseName("ix_organization_member_role_permissions_permission_id");

                    b.ToTable("organization_member_role_permissions", (string)null);
                });
            ...
            modelBuilder.Entity("Edvantix.Organizational.Domain.AggregatesModel.GroupAggregate.GroupMembershipHistory", b =>
                {
                    b.HasOne("Edvantix.Organizational.Domain.AggregatesModel.GroupAggregate.GroupMember", null)
                        .WithMany("History")
                        .HasForeignKey("GroupMemberId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired()
                        .HasConstraintName("fk_group_membership_histories_group_members_group_member_id");
                });
            ...
            modelBuilder.Entity("Edvantix.Organizational.Infrastructure.OrganizationMemberRolePermission", b =>
                {
                    b.HasOne("Edvantix.Organizational.Domain.AggregatesModel.OrganizationMemberAggregate.OrganizationMemberRole", null)
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_organization_member_role_permissions_organization_member_ro");
                    ...
                    b.HasOne("Edvantix.Organizational.Domain.AggregatesModel.PermissionAggregate.Permission", null)
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_organization_member_role_permissions_permissions_permission");
                });
