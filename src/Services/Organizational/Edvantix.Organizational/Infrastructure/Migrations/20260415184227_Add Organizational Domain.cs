...
{
    /// <inheritdoc />
    public partial class AddOrganizationalDomain : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    table.PrimaryKey(
                        "pk_organization_member_role_permissions",
                        x => new { x.role_id, x.permission_id }
                    );
                    table.ForeignKey(
        ...
        protected override void Down(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.DropTable(name: "organization_member_role_permissions");
