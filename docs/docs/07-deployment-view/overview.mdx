...
sidebar_position: 1
title: Overview
description: Deployment architecture overview using Aspire for local development and Azure Container Apps for production
keywords: [deployment view, Aspire, Azure Container Apps, Docker, container orchestration, infrastructure, cloud deployment]
last_update:
  author: Nhan Nguyen
---
...
The Edvantix application is built using Aspire, a cloud-native application framework that orchestrates containerized services. The deployment architecture supports both local development and cloud production environments with Azure Container Apps.

## Application Host

The `Edvantix.AppHost` project serves as the orchestration layer, defining the entire application topology including:
