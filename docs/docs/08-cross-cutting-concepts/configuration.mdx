...
sidebar_position: 4
title: Configuration
description: Comprehensive configuration system with Aspire features, environment variables, and Azure App Configuration
keywords: [configuration, appsettings, environment variables, Azure App Configuration, Aspire configuration, service discovery]
last_update:
  author: Nhan Nguyen
---
...
The Edvantix application uses a comprehensive configuration system built on .NET's configuration framework, enhanced with Aspire-specific features and custom extensions.
