...
namespace Edvantix.Persona.Infrastructure.Migrations
{
    ...
    public partial class AddSkillsAndBio : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateIndex(name: "ix_skills_name", table: "skills", column: "name");
        }

        /// <inheritdoc />
        protected override void Down(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.DropTable(name: "profile_skill");

            migrationBuilder.DropTable(name: "skills");

            migrationBuilder.DropColumn(name: "bio", table: "profiles");
        }
    }
}
