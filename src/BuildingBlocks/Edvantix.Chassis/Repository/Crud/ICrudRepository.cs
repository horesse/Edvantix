    ...
    where TEntity : IAggregateRoot
{
    ...
    /// <returns></returns>
    Task<TEntity?> GetOrDefaultAsync(Expression<Func<TEntity, bool>> predicate, CancellationToken token);
    ...
    Task<List<TEntity>> InsertOrUpdateAsync(List<TEntity> entities,
        CancellationToken token);
