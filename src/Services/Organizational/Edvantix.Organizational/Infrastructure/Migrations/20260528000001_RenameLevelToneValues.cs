    ...
    public partial class RenameLevelToneValues : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.Sql(
                "UPDATE levels SET tone = 'Rose'    WHERE tone = 'Red';"
            );
            migrationBuilder.Sql(
                "UPDATE levels SET tone = 'Emerald' WHERE tone = 'Green';"
            );
        }
        ...
        {
            migrationBuilder.Sql(
                "UPDATE levels SET tone = 'Red'   WHERE tone = 'Rose';"
            );
            migrationBuilder.Sql(
                "UPDATE levels SET tone = 'Green' WHERE tone = 'Emerald';"
            );
        }
    }
}
