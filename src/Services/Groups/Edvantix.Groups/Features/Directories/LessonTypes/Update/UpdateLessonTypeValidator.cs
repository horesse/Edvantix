...
internal sealed class UpdateLessonTypeValidator : AbstractValidator<UpdateLessonTypeCommand>
{
    public UpdateLessonTypeValidator(ILessonTypeUniqueChecker uniqueChecker)
    {
        RuleFor(x => x.Name)
            .NotEmpty()
