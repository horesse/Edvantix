# Edvantix — Copilot instructions

## System overview

Edvantix is a microservices-based system built around .NET Aspire for service orchestration, local developer experience, and cloud-ready composition. It combines:
