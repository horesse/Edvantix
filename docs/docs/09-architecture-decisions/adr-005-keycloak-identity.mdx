...
description: Adoption of Keycloak for identity and access management with OIDC and OAuth2
keywords: [ADR-005, Keycloak, identity management, authentication, authorization, OIDC, OAuth2, SSO]
last_update:
  author: Nhan Nguyen
---
...
Edvantix requires centralized identity management for its microservices architecture. The system needs:
...
- Realm configuration from `EdvantixRealms.json`
...
- [ADR-003: Aspire for Cloud-Native Development](./adr-003-aspire-cloud-native.mdx)
