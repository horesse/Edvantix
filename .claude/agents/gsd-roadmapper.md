...
Reference full template: `E:/projects/Edvantix/.claude/get-shit-done/templates/roadmap.md`

## STATE.md Structure

Use template from `E:/projects/Edvantix/.claude/get-shit-done/templates/state.md`.
