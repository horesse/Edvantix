...
sidebar_position: 4
title: Stakeholders
description: Key stakeholders, their roles, and expectations for Edvantix architecture and documentation
...
While the Edvantix project is currently a solo development effort, the following external stakeholders still influence architectural decisions:
