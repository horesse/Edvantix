...
/// </summary>
public sealed class CancelInvitationEndpoint : IEndpoint<NoContent, CancelInvitationCommand, ISender>
{
    public void MapEndpoint(IEndpointRouteBuilder app)
    {
        app.MapDelete(
                "/organizations/{orgId:long}/invitations/{invitationId:guid}",
                async (Guid orgId, Guid invitationId, ISender sender, CancellationToken ct) =>
